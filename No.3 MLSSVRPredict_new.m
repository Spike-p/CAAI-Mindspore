function [predictY, TSE, R2]= MLSSVRPredict_new(tstX, tstY, trnX, alpha, b, lambda, p)
% 
...
K = (Kerfun('linear', tstX, trnX, p, 0)+Kerfun('poly', tstX, trnX, p, 0)+Kerfun('rbf', tstX, trnX, p, 0))/3; 
